    ...
    <section aria-label="hero">
      <FadeContainer className="relative flex flex-col items-center justify-center">
            ...
            <div className="inline-flex max-w-full items-center gap-3 rounded-full bg-white/5 px-2.5 py-0.5 pr-3 pl-0.5 font-medium text-gray-900 ring-1 shadow-lg shadow-emerald-400/20 ring-black/10 filter backdrop-blur-[1px] transition-colors hover:bg-emerald-500/[2.5%] focus:outline-hidden sm:text-sm">
              ...
              <span className="flex items-center gap-1 truncate">
                <span className="w-full truncate">
                  King Salman Park District Cooling
                </span>
        ...
        <h1 className="mt-8 text-center text-5xl font-semibold tracking-tighter text-gray-900 sm:text-8xl sm:leading-[5.5rem]">
          <FadeSpan>Powering</FadeSpan> <FadeSpan>the</FadeSpan>
          <br />
          <FadeSpan>Middle</FadeSpan> <FadeSpan>East</FadeSpan>
        </h1>
        <p className="mt-5 max-w-xl text-center text-base text-balance text-gray-700 sm:mt-8 sm:text-xl">
          <FadeSpan>Leading the transition toward a carbon-neutral</FadeSpan>{" "}
          <FadeSpan>economy through innovative energy solutions</FadeSpan>{" "}
          <FadeSpan>and sustainable infrastructure.</FadeSpan>
        </p>
        <FadeDiv>
          <a
